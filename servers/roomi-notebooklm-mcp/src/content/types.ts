...
// ============================================================================
// Source Text Extraction Types
// ============================================================================

/**
 * Input for getting the full text of a source
 *
 * This feature allows users to extract the complete text content from a source
 * document in NotebookLM, useful for further processing or analysis.
 */
export interface SourceTextInput {
  /** ID of the source (optional if sourceName provided) */
  sourceId?: string;
  /** Name of the source (partial match supported) */
  sourceName?: string;
}

/**
 * Result of extracting text from a source
 */
export interface SourceTextResult {
  ...
  /** Number of passages/chunks detected */
  passageCount?: number;
  /** Error message if failed */
  error?: string;
}
